(function() {
  ...
  var uppercase = document.getElementById('md5-uppercase');
  var runBtn = document.getElementById('md5-run');
  var copyBtn = document.getElementById('md5-copy');
